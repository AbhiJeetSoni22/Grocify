  ...
  return (
    <div className='mt-14 '>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-6 mt-6 '>
        ...
        <div key={index} className=' group cursor-pointer py-5 px-3 gap-2 rounded-lg flex flex-col justify-center items-center mb-10'
        style={{
            backgroundColor: category.bgColor
        }}
        onClick={()=>{
           navigate(`/dashboard/products/${category.path.toLowerCase()}`);
           scrollTo(0,0)
        }}
        >
